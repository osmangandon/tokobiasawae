...
echo "<h1>
CEKTARIF POS : $ku_asal ke $ku2_tujuan
</h1>
<hr>
$yuk_kd
<br>";
...
//PROSES ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//$nilainya = "cektarif.com+%3A+ongkir+pos+$ku_asal+ke+$ku2_tujuan";
$nilainya = "ongkir.co+%3A+ongkir+pos+$ku_asal+ke+$ku2_tujuan&oq=ongkir.co+%3A+ongkir+pos+$ku_asal+ke+$ku2_tujuan";
...
curl_setopt ($ch, CURLOPT_URL, "http://www.bing.com/search?q=$query&qs=n&form=QBLH&sp=-1&pq=undefined&sc=0-12&sk=&cvid=B39DA7713EB748E2A539CDF6736A4202".$query);
...
foreach($html_base->find('a') as $element) {
	...
	$url_asli = "http://ongkir.co/ongkir";
	$nilkux = substr($nilku,10,200);
...
/*
	if ($nilkux == $url_asli)
		...
		//update
		mysql_query("UPDATE antar_kota SET cektarif_pos = '$nilku3' ".
						"WHERE kd = '$yuk_kd'");
