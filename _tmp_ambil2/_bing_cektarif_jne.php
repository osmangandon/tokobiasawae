...
echo "<h1>
CEKTARIF JNE : $ku_prop1 [$ku_kota1] ke $ku_prop2 [$ku_kota2]
</h1>
<hr>";
...
foreach($html_base->find('a') as $element) {
	...
	if ($nilkux == $url_asli)
		...
		//update
		mysql_query("UPDATE ongkirnya SET cektarif_url = '$nilku3' ".
						"WHERE kd = '$ku_kd'");



		//null kan yang dari..
		mysql_query("UPDATE ongkirnya SET cektarif_url = '' ".
						"WHERE cektarif_url LIKE '%dari%'");
