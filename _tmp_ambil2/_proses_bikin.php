...
$jml_jne_reg = round($jml_total - ((10/100) * $jml_total));
$jml_pos_express = round($jml_total - ((20/100) * $jml_total));
$jml_pos_kilat = round($jml_total - ((25/100) * $jml_total));
$jml_tiki_express = round($jml_total - ((11/100) * $jml_total));
$jml_tiki_reguler = round($jml_total - ((15/100) * $jml_total));
